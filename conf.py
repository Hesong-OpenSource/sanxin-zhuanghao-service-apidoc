...
def setup(app):
    StandardDomain.initial_data['labels']['routingtable'] = ('http-routingtable', 'HTTP 路由表', 'HTTP Routing Table')
    StandardDomain.initial_data['anonlabels']['routingtable'] = ('http-routingtable', 'http-routingtable')
